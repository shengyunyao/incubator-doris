...
#    ["STRING_IS_NULL", "IrIsNullString"],
    ["HLL_UPDATE_BOOLEAN", "hll_updateIN9doris_udf10BooleanVal"],
    ["HLL_UPDATE_TINYINT", "hll_updateIN9doris_udf10TinyIntVal"],
    ["HLL_UPDATE_SMALLINT", "hll_updateIN9doris_udf11SmallIntVal"],
    ["HLL_UPDATE_INT", "hll_updateIN9doris_udf6IntVal"],
    ["HLL_UPDATE_BIGINT", "hll_updateIN9doris_udf9BigIntVal"],
    ["HLL_UPDATE_FLOAT", "hll_updateIN9doris_udf8FloatVal"],
    ["HLL_UPDATE_DOUBLE", "hll_updateIN9doris_udf9DoubleVal"],
    ["HLL_UPDATE_STRING", "hll_updateIN9doris_udf9StringVal"],
    ["HLL_UPDATE_TIMESTAMP", "hll_updateIN9doris_udf11DateTimeVal"],
    ["HLL_UPDATE_DECIMAL", "hll_updateIN9doris_udf10DecimalVal"],
    ["HLL_MERGE", "hll_merge"],
